...
**ESP32 Dynamic DC Load Firmware — v7.1.2**  
...
Works with the [Battery Tester Python app](BattTester_v2.1.2/) for real-time battery test monitoring and data logging.
