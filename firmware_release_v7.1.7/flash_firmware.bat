@echo off
echo ============================================
echo Dynamic Load Firmware v7.1.7 Flash Tool
echo ============================================
echo.
...
python -m esptool --chip esp32 --port %COM_PORT% --baud 460800 write_flash -z 0x1000 bootloader.bin 0x8000 partitions.bin 0x10000 firmware.bin

if %ERRORLEVEL% EQU 0 (
    echo.
    echo ============================================
    echo SUCCESS! Firmware v7.1.7 flashed successfully.
    echo ============================================
    echo.
